...
kg/kissy-pagination/2.0.0/index
 ...
 **/
KISSY.add('kg/kissy-pagination/2.0.0/index',function(S,Base,Node,Event,DOM) {
  "use strict";
  ...
  var attrs={
     ...
     */
    styleSheet:{
      value:'http://kg.kissyui.com/kissy-pagination/2.0.0/src/style.css'
    },
  ...
  S.extend(Pagination, Base, /** @lends Pagination.prototype*/{
    ...
    _init:function(){
      var style=S.trim(this.get('styleSheet'));
      if(style){
        S.one('head').append('<link rel="stylesheet" href="'+style+'">');
      }
      this._render()
          ._event();
    },
